"""
Django settings for gentle_snowflake_26 project.
...
ROOT_URLCONF = 'gentle_snowflake_26.urls'
...
WSGI_APPLICATION = 'gentle_snowflake_26.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_snowflake_26 API",
    "DESCRIPTION": "API documentation for gentle_snowflake_26 App",
    "VERSION": "v1",
}
